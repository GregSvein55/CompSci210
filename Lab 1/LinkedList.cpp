...
200427591
Why program crashes originally: The program tried to delete a node that didn't exist

How I fixed the problem: I added a nested if statement in the program to tell it what to do if it couldn't find the value

Does there need to be an order to whats inside a key conditional statement: Yes
*/
void LinkedList::deleteItem (int item)
{
   ...
   else
   {
       ...
       {
           //printing a value not found message
